...
: Development and operation of internal marketing technology platform, automated reporting & analytics, domain-specific automation.
    - Back-end software development in Python<i class="devicon-python-plain colored"></i>
...
- DevOps & infrastructure
  ...
  - CI/CD: Jenkins <i class="devicon-jenkins-plain"></i>, CircleCI <i class="devicon-circleci-plain"></i>, Zuul <i class="devicon-zuul-plain"></i>
...
- Storage technology
  ...
  - Queues/log-oriented: Kafka<i class="devicon-apachekafka-original"></i>, RabbitMQ<span class="iconify-inline" data-icon="logos:rabbitmq-icon"></span>
